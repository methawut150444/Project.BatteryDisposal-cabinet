...
void Func_PostAA(){
  HTTPClient http;
  String url="https://script.google.com/macros/s/AKfycbzXlOKA8GWo1rKT5AZZ5oUXg1pK29nyx0Fb8KLZF2TYSuSnJv9DFNHIoY4nvFCTRd2TEg/exec?Post=1&ID=1&AA=1&AAA=0";
...
void Func_PostAAA(){
  HTTPClient http;
  String url="https://script.google.com/macros/s/AKfycbzXlOKA8GWo1rKT5AZZ5oUXg1pK29nyx0Fb8KLZF2TYSuSnJv9DFNHIoY4nvFCTRd2TEg/exec?Post=1&ID=1&AA=0&AAA=1";  
  http.begin(url.c_str()); 
  http.setFollowRedirects(HTTPC_STRICT_FOLLOW_REDIRECTS);

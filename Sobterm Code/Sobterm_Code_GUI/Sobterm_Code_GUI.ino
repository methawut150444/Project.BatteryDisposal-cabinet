...
#define ssid "3BB_ipcam2.4G"
#define pass "11551155"
...
//____________________________________________________< define: lamp >
#define lamp 12
...
void Func_StateMachine(){
  switch(state){
    //_____________________< PreScreenBegin >
    case 0:
      uint16_t x0, y0;
    ...
    //_____________________< MainScreen >
    case 1:
      //_____________________< Interupt >
      if(millis() - lst >= 100){
        lst = millis();
    ...
    //_____________________< After pushed let's compute Button >
    case 9:
      uint16_t x9, y9;
    ...
    //_____________________< warpping batt state >
    case 10:
      Warpping_Batt();
    ...
    //_____________________< InputPhoneNumberScreen 1 >
    case 2:
      uint16_t x2, y2;
    ...
    //_____________________< InputPhoneNumberScreen 2>
    case 3:
      Func_InputPhoneNumberScreen();
      if(PhoneNumber.length() == 10){
    ...
    //_____________________< Popup Screen >
    case 4:
      Func_PopupThank();
      delay(5000);
      Func_PreScreen();
...
void CountAll_IRsensor(){
  ...
  CurVal_senL = digitalRead(39);
  if(CurVal_senL != LstVal_senL){
    if(CurVal_senL == 0){
      Count_senL++;
      count_AAtoWarp++;
      QTY_AA = Count_senL;
      url = "https://script.google.com/macros/s/AKfycbzXlOKA8GWo1rKT5AZZ5oUXg1pK29nyx0Fb8KLZF2TYSuSnJv9DFNHIoY4nvFCTRd2TEg/exec?Post=1&ID=1&AA=1&AAA=0";
      Func_record();
  ...
  CurVal_senR = digitalRead(36);
  if(CurVal_senR != LstVal_senR){
    if(CurVal_senR == 0){
      Count_senR++;
      count_AAAtoWarp++;
      QTY_AAA = Count_senR;
      url = "https://script.google.com/macros/s/AKfycbzXlOKA8GWo1rKT5AZZ5oUXg1pK29nyx0Fb8KLZF2TYSuSnJv9DFNHIoY4nvFCTRd2TEg/exec?Post=1&ID=1&AA=0&AAA=1";
      Func_record();
      // ----------------< change screen & update values >
      Func_MainScreen();
    }
